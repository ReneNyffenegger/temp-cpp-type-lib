...
std::wstring TypeAsString(VARTYPE vt){
  switch (vt) {
    ...
    return L"VT_BYREF|VT_UI1";

    case    VT_BYREF|VT_I2:
    return L"VT_BYREF|VT_I2";

    case    VT_BYREF|VT_I4:
    return L"VT_BYREF|VT_I4";

    case    VT_BYREF|VT_R4:
    return L"VT_BYREF|VT_R4";

    case    VT_BYREF|VT_R8:
    return L"VT_BYREF|VT_R8";

    case    VT_BYREF|VT_BOOL:
    return L"VT_BYREF|VT_BOOL";

    case    VT_BYREF|VT_ERROR:
    return L"VT_BYREF|VT_ERROR";

    case    VT_BYREF|VT_CY:
    return L"VT_BYREF|VT_CY";

    case    VT_BYREF|VT_DATE:
    return L"VT_BYREF|VT_DATE";

    case    VT_BYREF|VT_BSTR:
    return L"VT_BYREF|VT_BSTR";

    case    VT_BYREF|VT_UNKNOWN:
    return L"VT_BYREF|VT_UNKNOWN";

    case    VT_BYREF|VT_DISPATCH:
    return L"VT_BYREF|VT_DISPATCH";

    //case    VT_ARRAY|*:
    //return L"VT_ARRAY|*";

    case    VT_BYREF|VT_VARIANT:
    return L"VT_BYREF|VT_VARIANT";
    ...
    case    VT_BYREF|VT_I1:
    return L"VT_BYREF|VT_I1";

    case    VT_BYREF|VT_UI2:
    return L"VT_BYREF|VT_UI2";

    case    VT_BYREF|VT_UI4:
    return L"VT_BYREF|VT_UI4";

    case    VT_BYREF|VT_INT:
    return L"VT_BYREF|VT_INT";

    case    VT_BYREF|VT_UINT:
    return L"VT_BYREF|VT_UINT";
